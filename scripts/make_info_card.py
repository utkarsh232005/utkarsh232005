...
colored key/value rows for role, tech stack, and highlights -- NOT GitHub stats
(the contribution graph covers those).
...
ROWS = [
    ...
    ("kv", "Focus", "DevOps & Cloud Enthusiast"),
    ("kv", "Passion", "Tech Explorer & Builder"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "JS, TS, Python, HTML, CSS"),
    ("kv", "Frontend", "React, Next.js, Tailwind"),
    ("kv", "Backend", "Node.js, Express, REST APIs"),
    ("kv", "DevOps", "Docker, K8s, GitHub Actions"),
    ("kv", "Cloud", "AWS, GCP, Linux, Nginx"),
    ("kv", "DB", "MongoDB, MySQL, Firebase"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Open-source contributor (16+ merged PRs)"),
    ("bul", "Building full-stack apps & cloud infra"),
    ("bul", "Exploring CI/CD, IaC & automation"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">utkarsh@github: ~$ neofetch</text>')
